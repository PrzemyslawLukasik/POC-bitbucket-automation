...
class FaPopupPo:
    ...
    def fa_header_visible(self) -> bool:
        return True if self.locators.fa_heading_locator().is_visible(timeout=10000) else False
    ...
    def is_dashboard_link_visible(self) -> bool:
        ...
        return True if self.locators.dashboard_link_locator().is_visible(timeout=10000) else False
